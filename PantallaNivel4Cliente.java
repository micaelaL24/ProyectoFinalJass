...
public class PantallaNivel4Cliente extends PantallaNivel4 implements ClientNetworkListener {
    ...
    public PantallaNivel4Cliente(ClientThread client, int playerNum) {
        super();
    ...
    @Override
    public void hide() {
        System.out.println("[CLIENT] Cerrando PantallaNivel4Cliente → enviando Disconnect");
