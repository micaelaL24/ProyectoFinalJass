...
public class PantallaNivel5Cliente extends PantallaNivel5 implements ClientNetworkListener {
    ...
    public PantallaNivel5Cliente(ClientThread client, int playerNum) {
        super();
    ...
    @Override
    public void hide() {
        System.out.println("[CLIENT] Cerrando PantallaNivel5Cliente → enviando Disconnect");
