...
public class PantallaNivel1Cliente extends PantallaNivel1 implements ClientNetworkListener {
    ...
    public PantallaNivel1Cliente(ClientThread client, int playerNum) {
        super();
    ...
    @Override
    public void hide() {
        System.out.println("[CLIENT] Cerrando PantallaNivel1Cliente → enviando Disconnect");
