...
public class PantallaNivel3Cliente extends PantallaNivel3 implements ClientNetworkListener {
    ...
    public PantallaNivel3Cliente(ClientThread client, int playerNum) {
        super();
    ...
    @Override
    public void hide() {
        System.out.println("[CLIENT] Cerrando PantallaNivel3Cliente → enviando Disconnect");
