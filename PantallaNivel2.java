...
public class PantallaNivel2 extends PantallaNivelBase implements Screen {
    ...
    public void show() {
        // Cargar mapa
        mapa = new TmxMapLoader().load(Recursos.MENUNIVEL2);
