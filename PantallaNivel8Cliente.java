...
public class PantallaNivel8Cliente extends PantallaNivel8 implements ClientNetworkListener {
    ...
    public PantallaNivel8Cliente(ClientThread client, int playerNum) {
        super();
    ...
    @Override
    public void hide() {
        System.out.println("[CLIENT] Cerrando PantallaNivel8Cliente → enviando Disconnect");
