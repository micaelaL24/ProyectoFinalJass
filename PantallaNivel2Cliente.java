...
public class PantallaNivel2Cliente extends PantallaNivel2 implements ClientNetworkListener {
    ...
    public PantallaNivel2Cliente(ClientThread client, int playerNum) {
        super();
