...
public class PantallaNivel9Cliente extends PantallaNivel9 implements ClientNetworkListener {
    ...
    public PantallaNivel9Cliente(ClientThread client, int playerNum) {
        super();
    ...
    @Override
    public void hide() {
        System.out.println("[CLIENT] Cerrando PantallaNivel9Cliente → enviando Disconnect");
