...
public class PantallaNivel10Cliente extends PantallaNivel10 implements ClientNetworkListener {
    ...
    public PantallaNivel10Cliente(ClientThread client, int playerNum) {
        super();
    ...
    @Override
    public void hide() {
        System.out.println("[CLIENT] Cerrando PantallaNivel10Cliente → enviando Disconnect");
