...
public class PantallaNivel6Cliente extends PantallaNivel6 implements ClientNetworkListener {
    ...
    public PantallaNivel6Cliente(ClientThread client, int playerNum) {
        super();
    ...
    @Override
    public void hide() {
        System.out.println("[CLIENT] Cerrando PantallaNivel6Cliente → enviando Disconnect");
