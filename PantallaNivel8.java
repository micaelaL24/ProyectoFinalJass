...
public class PantallaNivel8 extends PantallaNivelBase implements Screen {
    ...
    public void show() {
        // Cargar mapa
        mapa = new TmxMapLoader().load(Recursos.MENUNIVEL8);
        ...
        System.out.println("Nivel 8 cargado:");
        ...
        // Timer (85 segundos para nivel 8)
