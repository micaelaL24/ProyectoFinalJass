...
public class PantallaNivel6 extends PantallaNivelBase implements Screen {
    ...
    public void show() {
        // Cargar mapa
        mapa = new TmxMapLoader().load(Recursos.MENUNIVEL6);
        ...
        jugadorLuna = new Jugador(150, 200, TipoJugador.AGUA);  // Luna = Agua
        jugadorSol = new Jugador(250, 200, TipoJugador.FUEGO);  // Sol = Fuego
        ...
        System.out.println("Nivel 6 cargado:");
        ...
        // Configurar timer
        timer.setTiempoRestante(120.0f);
