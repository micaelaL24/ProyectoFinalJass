...
public class PantallaNivel10 extends PantallaNivelBase implements Screen {
    ...
    public void show() {
        // Cargar mapa
        mapa = new TmxMapLoader().load(Recursos.MENUNIVEL10);
        ...
        jugadorLuna = new Jugador(100, 100, TipoJugador.AGUA);
        jugadorSol = new Jugador(200, 100, TipoJugador.FUEGO);
        ...
        // Timer (85 segundos para nivel 10)
